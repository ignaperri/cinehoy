...
import com.nachomp.cinehoy.ui.popular.PopularFragment;
...
public class TopRatedMovieRecyclerViewAdapter extends RecyclerView.Adapter<TopRatedMovieRecyclerViewAdapter.ViewHolder> {
    ...
    public TopRatedMovieRecyclerViewAdapter(TopRatedFragment fragment, Context ctx, List<MovieEntity> items) {
        mValues = items;
        context = ctx;

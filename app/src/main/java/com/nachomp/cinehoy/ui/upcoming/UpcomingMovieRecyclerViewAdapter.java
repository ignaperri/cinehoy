...
import com.nachomp.cinehoy.ui.toprated.TopRatedFragment;

import java.util.List;

public class UpcomingMovieRecyclerViewAdapter extends RecyclerView.Adapter<UpcomingMovieRecyclerViewAdapter.ViewHolder> {

    private List<MovieEntity> mValues;
    private Context context;
    private UpComingFragment fragment;

    public UpcomingMovieRecyclerViewAdapter(UpComingFragment fragment, Context ctx, List<MovieEntity> items) {
        mValues = items;
        context = ctx;
